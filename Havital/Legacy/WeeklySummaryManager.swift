...
/// - 數據存取: TrainingPlanRepository.getWeeklySummaries() / createWeeklySummary()
/// - ViewModel: WeeklySummaryViewModel (Features/TrainingPlan/Presentation/ViewModels/)
@available(*, deprecated, message: "Use TrainingPlanRepository.getWeeklySummaries() instead")
