...
///
/// ⚠️ DEPRECATED: 此橋接類應該被移除
/// 遷移計劃:
/// 1. 直接使用 UserProfileRepository 獲取心率數據
/// 2. 移除此橋接模式，改用 UseCase 直接調用 Repository
@available(*, deprecated, message: "Bridge pattern should be removed, use UserProfileRepository directly")
