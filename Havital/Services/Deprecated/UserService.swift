...
//
// ✅ 已遷移 (使用新層):
//   - getUserProfileAsync() → UserProfileRepository.getUserProfile()
//   - updateUserData() → UserProfileRepository.updateUserProfile()
//   - updateDataSource() → UserProfileRepository.updateDataSource()
//   - deleteUser() → UserProfileRepository.deleteAccount()
//   - createTarget() → TargetRepository.createTarget()
//
// ✅ 保留使用:
//   - loginWithGoogle() - 特殊認證邏輯，保留在 AuthenticationService 使用
//   - syncUserPreferences() - 本地偏好同步邏輯
//
// 📝 遷移指南:
//   - 如需用戶資料操作: 使用 UserProfileRepository via UserProfileFeatureViewModel
//   - 如需賽事操作: 使用 TargetRepository via TargetFeatureViewModel
//   - 如需 Google 登入: 保留使用此 Service (經由 AuthenticationService)
...
class UserService {
    ...
    /// ⚠️ DEPRECATED: Use TargetRepository.createTarget() instead
    @available(*, deprecated, message: "Use TargetRepository.createTarget() via TargetFeatureViewModel")
    ...
    /// ⚠️ DEPRECATED: Use UserProfileRepository.updateUserProfile() instead
    @available(*, deprecated, message: "Use UserProfileRepository.updateUserProfile() via UserProfileFeatureViewModel")
    ...
    /// ⚠️ DEPRECATED: Use UserProfileRepository.updateDataSource() instead
    @available(*, deprecated, message: "Use UserProfileRepository.updateDataSource() via UserProfileFeatureViewModel")
    ...
    /// ⚠️ DEPRECATED: Use UserProfileRepository.getUserProfile() instead
    @available(*, deprecated, message: "Use UserProfileRepository.getUserProfile() via UserProfileFeatureViewModel")
    ...
    /// ⚠️ DEPRECATED: Use UserProfileRepository.deleteAccount() instead
    @available(*, deprecated, message: "Use UserProfileRepository.deleteAccount() via UserProfileFeatureViewModel")
